...
This meta skill is OPTIMIZER-SIDE ONLY. It is never shipped with the target skill.
It lives in optimizer-memory.jsonl and is prepended to future optimizer prompts.
It does NOT appear in best_skill.md.
